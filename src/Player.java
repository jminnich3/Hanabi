...
public class Player {
	...
	public boolean isObviousPlay(Card c, Board boardState){
		if(c.value == boardState.tableau.get(c.color)+1)

		//				Card c = partnerHand.get(idx);
//				if(isObviousPlay(c, boardState)){
//					//play it
//				}
	}

	public boolean isObviousDiscard(Card c, Board boardState){
		// discard when ...
		// the card you have is less than
	}
